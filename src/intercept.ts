...
export function intercept(currentHeads: Heads, change: (_: ChangeFn) => Doc<any>, intercepted: Transaction, state: EditorState): EditorState {
  ...
  let tx = amToPm(diff, path, state.tr)
